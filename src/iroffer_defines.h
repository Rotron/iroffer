...
#define ACTUAL_MAXSETSIZE                                                      \
    min2(((int)gdata.max_fds_from_rlimit), ((int)FD_SETSIZE))
...
#define MAXTRANS                                                               \
    (((ACTUAL_MAXSETSIZE)-RESERVED_FDS - (MAXUPLDS * 2) - MAXCHATS) / 2)
