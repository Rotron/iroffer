...
typedef enum { how_direct = 1, how_bnc, how_wingate, how_custom } how_e;
...
#endif
    ioutput(calltype_e type, int dest, unsigned int color_flags,
            const char* format, ...);
...
void plugin_ircprivmsg(const char* fullline, const char* nick,
                       const char* hostname, const char* dest, const char* msg1,
                       const char* msg2, const char* msg3, const char* msg4,
                       const char* msg5);
void plugin_ircinput(const char* fullline, const char* part2, const char* part3,
                     const char* part4);
